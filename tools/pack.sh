...
# ── per-component knobs ──────────────────────────────────────────────────────
ID=lumen-shell                    # herald package id (== repo name)
NAME="Desktop shell"              # human-readable name
DESTBIN=bin/lumen-shell           # where the binary installs (verbatim runtime path)
